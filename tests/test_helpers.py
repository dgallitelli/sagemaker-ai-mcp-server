...
class TestHelpers:
    ...
    @pytest.mark.asyncio
    @patch('sagemaker_ai_mcp_server.helpers.get_sagemaker_client')
    async def test_create_app(self, mock_get_sagemaker_client):
    ...
    @pytest.mark.asyncio
    @patch('sagemaker_ai_mcp_server.helpers.get_sagemaker_client')
    async def test_delete_app(self, mock_get_sagemaker_client):
        """Test delete_app function."""
        mock_client = MagicMock()
        mock_get_sagemaker_client.return_value = mock_client
    ...
    @pytest.mark.asyncio
    @patch('sagemaker_ai_mcp_server.helpers.get_sagemaker_client')
    async def test_delete_app_image_config(self, mock_get_sagemaker_client):
        """Test delete_app_image_config function."""
        mock_client = MagicMock()
        mock_get_sagemaker_client.return_value = mock_client
    ...
    @pytest.mark.asyncio
    @patch('sagemaker_ai_mcp_server.helpers.get_sagemaker_client')
    async def test_describe_app(self, mock_get_sagemaker_client):
        """Test describe_app function."""
        mock_client = MagicMock()
        expected_response = {
            'DomainId': 'test-domain',
    ...
    @pytest.mark.asyncio
    @patch('sagemaker_ai_mcp_server.helpers.get_sagemaker_client')
    async def test_describe_app_image_config(self, mock_get_sagemaker_client):
        """Test describe_app_image_config function."""
        mock_client = MagicMock()
        expected_response = {
        ...
        mock_get_sagemaker_client.assert_called_once()
        mock_client.describe_app_image_config.assert_called_once_with(
    ...
    @pytest.mark.asyncio
    @patch('sagemaker_ai_mcp_server.helpers.get_sagemaker_client')
    async def test_list_apps(self, mock_get_sagemaker_client):
    ...
    @pytest.mark.asyncio
    @patch('sagemaker_ai_mcp_server.helpers.get_sagemaker_client')
    async def test_create_presigned_notebook_instance_url(self, mock_get_sagemaker_client):
        """Test create_presigned_notebook_instance_url function."""
        mock_client = MagicMock()
